...
function game(options){
    ...
    const removeoptions=removeimages();
...
function gamemessage(gamescore){
    ...
    switch(gamescore){
        ...
        case 0:
            ...
            break;
        case 0.5:
            result={message:"you tie",color:"yellow"}
...
function frontend(userchoice,botchoice,finalmessage){
    mainDiv.innerHTML=`<img class="final" id="userchoice" src="${imagedatabase[userchoice]}" alt="${userchoice}" width="100px" height="100px"/>
    <h2 class="final" style="color:${finalmessage['color']}">${finalmessage['message']}</h2>
    <img class ="final" id="boptchoice" src="${imagedatabase[botchoice]}" alt="${botchoice}" width="100px" height="100px"/>`;
